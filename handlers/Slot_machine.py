...
from keyboards.defualt.request_game import slot_machine
import time
...
async def game(call: types.CallbackQuery, state: FSMContext):
    ...
    await call.message.answer("Видишь Как я умею!\nТвой черед, бросай ты!🙃", reply_markup=slot_machine)
